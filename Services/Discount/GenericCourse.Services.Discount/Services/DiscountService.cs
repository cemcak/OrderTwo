...
namespace GenericCourse.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Create(Models.Discount discount)
        {
            ...
            if (status < 1)
            {
                return Response<NoContent>.Fail("An error occured while create", 500);
            }
        ...
        public async Task<Response<NoContent>> Update(Models.Discount discount)
        {
            ...
            if (status < 1)
            {
                return Response<NoContent>.Fail("An error occured while update", 500);
            }
        ...
        public async Task<Response<NoContent>> Delete(int id)
        {
            ...
            if (status < 1)
            {
                return Response<NoContent>.Fail("An error occured while delete", 500);
            }
